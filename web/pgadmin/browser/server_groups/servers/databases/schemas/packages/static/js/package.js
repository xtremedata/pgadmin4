define('pgadmin.node.package', [
  ...
  if (!pgBrowser.Nodes['coll-package']) {
    pgBrowser.Nodes['coll-package'] = pgBrowser.Collection.extend({
      node: 'package', label: gettext('Packages'), type: 'coll-package',
    ...
    pgBrowser.Nodes.package = pgBrowser.Node.extend({
      ...
      canCreate: function(itemData, item, data) {
        ...
        var treeData = this.getTreeNodeHierarchy(item),
          server = treeData && treeData.server;
      ...
      model: pgBrowser.Node.Model.extend({
        ...
        validate: function() {
          ...
          if (
            _.isUndefined(this.get('pkgheadsrc')) ||
