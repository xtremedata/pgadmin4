...
define('pgadmin.node.trigger_function', [
  ...
  if (!pgBrowser.Nodes['coll-trigger_function']) {
    pgBrowser.Nodes['coll-trigger_function'] = pgBrowser.Collection.extend({
      node: 'trigger_function', label: gettext('Trigger functions'),
      type: 'coll-trigger_function', hasStatistics: true,
    ...
    pgBrowser.Nodes.trigger_function = pgBrowser.Node.extend({
      ...
      model: pgBrowser.Node.Model.extend({
        ...
        schema: [{
          ...
          url: 'get_languages', disabled: 'isDisabled', transform: function(d) {
          ...
          visible: function(m) { return m.get('lanname') === 'c'; },
          disabled: 'isDisabled',
        },{
        ...
        validate: function(keys) {
          ...
          if (
            _.isUndefined(this.get('funcowner')) ||
              String(this.get('funcowner')).replace(/^\s+|\s+$/g, '') === ''
          ) {
          ...
          if (
            _.isUndefined(this.get('pronamespace')) ||
              String(this.get('pronamespace')).replace(/^\s+|\s+$/g, '') === ''
          ) {
          ...
          if (
            _.isUndefined(this.get('prorettypename')) ||
              String(this.get('prorettypename')).replace(/^\s+|\s+$/g, '') === ''
          ) {
          ...
          if (
            _.isUndefined(this.get('lanname')) ||
              String(this.get('lanname')).replace(/^\s+|\s+$/g, '') === ''
          ) {
          ...
          if (String(this.get('lanname')) == 'c') {
            if (
              _.isUndefined(this.get('probin')) ||
                String(this.get('probin')).replace(/^\s+|\s+$/g, '') === ''
            ) {
            ...
            if (
              _.isUndefined(this.get('prosrc_c')) ||
                String(this.get('prosrc_c')).replace(/^\s+|\s+$/g, '') === ''
            ) {
        ...
        isVisible: function() { return this.name !== 'sysproc'; },
