define('pgadmin.node.sequence', [
  ...
  'pgadmin.browser', 'pgadmin.browser.collection', 'pgadmin.node.schema',
  ...
  if (!pgBrowser.Nodes['coll-sequence']) {
    pgBrowser.Nodes['coll-sequence'] = pgBrowser.Collection.extend({
      node: 'sequence', label: gettext('Sequences'), type: 'coll-sequence',
      columns: ['name', 'seqowner', 'comment'], hasStatistics: true,
    });
  }
    ...
    pgBrowser.Nodes.sequence = pgBrowser.Node.extend({
      ...
      model: pgBrowser.Node.Model.extend({
        ...
        validate: function() {
          ...
          if (
            _.isUndefined(this.get('seqowner')) ||
          ...
          if (!this.isNew()) {
            if (
              _.isUndefined(this.get('current_value')) ||
            ...
            if (
              _.isUndefined(this.get('increment')) ||
            ...
            if (
              _.isUndefined(this.get('minimum')) ||
            ...
            if (
              _.isUndefined(this.get('maximum')) ||
