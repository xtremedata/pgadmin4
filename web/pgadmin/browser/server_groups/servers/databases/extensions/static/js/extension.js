define('pgadmin.node.extension', [
  ...
  if (!pgBrowser.Nodes['coll-extension']) {
    pgBrowser.Nodes['coll-extension'] = pgBrowser.Collection.extend({
      node: 'extension', label: gettext('Extension'), type: 'coll-extension',
  ...
  if (!pgBrowser.Nodes['extension']) {
    pgBrowser.Nodes['extension'] =
      pgBrowser.Node.extend({
