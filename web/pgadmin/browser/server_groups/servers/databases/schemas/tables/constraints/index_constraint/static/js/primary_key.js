define('pgadmin.node.primary_key', [
  ...
  'sources/pgadmin', 'pgadmin.backform', 'pgadmin.backgrid', 'pgadmin.browser',
  'pgadmin.browser.collection',
], function(gettext, url_for, $, _, pgAdmin, Backform, Backgrid, pgBrowser) {
      ...
      model: pgAdmin.Browser.Node.Model.extend({
        ...
        schema: [{
          ...
          cell: Backgrid.StringCell.extend({
            ...
            render: function() {
              return Backgrid.StringCell.prototype.render.apply(
                this, arguments
              );
            },
            remove: function() {
