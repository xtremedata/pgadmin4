...
define('tools.restore', [
  ...
  'pgadmin.browser.tool', 'backbone', 'pgadmin.backform',
], function(
  gettext, url_for, $, _, S, alertify, pgBrowser, pgTool, Backbone,
  Backform
) {
  ...
  var CustomSwitchControl = Backform.SwitchControl.extend({
    template: _.template([
  ...
  var RestoreObjectModel = Backbone.Model.extend({
    ...
    initialize: function(attrs) {
      ...
      if (node_type) {
        // Only_Schema option
        if (
          node_type === 'function' || node_type === 'index' ||
            node_type === 'trigger'
        ) {
    ...
    schema: [{
      ...
      schema:[{
        ...
        control: CustomSwitchControl, group: gettext('Sections'),
      ...
      schema:[{
        ...
        control: CustomSwitchControl, group: gettext('Type of objects'),
      ...
      schema:[{
        ...
        control: CustomSwitchControl, disabled: false, group: gettext('Do not save'),
      },{
      ...
      schema:[{
        ...
        control: CustomSwitchControl, disabled: false, group: gettext('Queries'),
      },{
        id: 'clean', label: gettext('Clean before restore'),
        control: CustomSwitchControl, group: gettext('Queries'),
        disabled: function() {
      ...
      schema:[{
        ...
        control: CustomSwitchControl, group: gettext('Disable'),
      },{
        id: 'no_data_fail_table', label: gettext('No data for Failed Tables'),
        control: CustomSwitchControl, disabled: false, group: gettext('Disable'),
      }],
    },{
      ...
      schema:[{
        ...
        control: CustomSwitchControl, disabled: false,
                  ...
                  success: function(res) {
                    if (res.success) {
                      ...
                      pgBrowser.Events.trigger(
                        'pgadmin-bgprocess:created', self
                      );
                    }
                  },
                  error: function(xhr) {
