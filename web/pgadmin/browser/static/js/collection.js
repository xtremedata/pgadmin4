define([
  ...
  'sources/pgadmin', 'backbone', 'pgadmin.alertify', 'pgadmin.backform',
  'pgadmin.backgrid', 'sources/browser/generate_url',
  'pgadmin.browser.node',
], function(
  gettext, $, _, S, pgAdmin, Backbone, Alertify, Backform, Backgrid, generateUrl
) {
