define('pgadmin.node.server', [
  ...
  'pgadmin.backform', 'pgadmin.browser', 'pgadmin.server.supported_servers',
  'pgadmin.user_management.current_user', 'pgadmin.alertify',
  'pgadmin.browser.server.privilege',
], function(
  gettext, url_for, $, _, Backbone, Backform, pgBrowser, supported_servers,
  current_user, alertify
) {
  ...
  pgBrowser.Nodes.server = pgBrowser.Node.extend({
    ...
    callbacks: {
      ...
      added: function(item, data) {
        ...
        pgBrowser.Node.callbacks.added.apply(this, arguments);
        return true;
      },
      ...
      reload_configuration: function(args){
        ...
        alertify.confirm(
          ...
          gettext(
            'Are you sure you want to reload the server configuration on %(label)s?', {
              label: d._label,
            }),
          function() {
            $.ajax({
