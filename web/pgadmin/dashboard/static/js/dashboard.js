define('pgadmin.dashboard', [
  ...
  'sources/pgadmin', 'backbone', 'pgadmin.backform', 'pgadmin.backgrid',
  'flotr2', 'pgadmin.alertify', 'backgrid.filter', 'pgadmin.browser',
  'bootstrap',
], function(
  url_for, gettext, r, $, _, pgAdmin, Backbone, Backform, Backgrid, Flotr,
  alertify
) {
  ...
  var ActiveQueryDetailsModel = Backbone.Model.extend({
    ...
    schema: [{
      ...
      visible: function() { return this.version >= 100000; },
    },{
