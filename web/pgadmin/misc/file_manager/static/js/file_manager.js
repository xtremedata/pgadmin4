define('misc.file_manager', [
  ...
  'pgadmin.alertify', 'pgadmin.browser.tool',
  ...
  pgAdmin.FileManager = pgTool.extend({
    Init: function() {
      ...
      alertify.dialog('fileSelectionDlg', function() {
        // Dialog containter
        var $container = $('<div class=\'storage_dialog file_selection_dlg\'></div>'),
          trans_id;
      ...
      alertify.dialog('createModeDlg', function() {
        // Dialog containter
        var $container = $('<div class=\'storage_dialog create_mode_dlg\'></div>'),
          trans_id;
