define('pgadmin.node.pga_jobstep', [
  ...
  'underscore.string', 'sources/pgadmin', 'pgadmin.browser', 'backform',
  'backgrid', 'pgadmin.backform', 'pgadmin.backgrid',
], function(gettext, url_for, $, _, S, pgAdmin, pgBrowser, Backform, Backgrid) {
      ...
      model: pgBrowser.Node.Model.extend({
        ...
        schema: [{
          ...
          deps: ['jstkind', 'jstconntype'], disabled: function(m) {
            ...
            'Please specify the connection string for the remote database server. Each parameter setting is in the form keyword = value. Spaces around the equal sign are optional. To write an empty value, or a value containing spaces, surround it with single quotes, e.g., keyword = \'a value\'. Single quotes and backslashes within the value must be escaped with a backslash, i.e., \' and \\.<br>For more information, please see the documentation on <a href="https://www.postgresql.org/docs/current/static/libpq-connect.html#LIBPQ-CONNSTRING" target="_blank">libpq connection strings</a>'
          ), mode: ['create', 'edit'],
        },{
