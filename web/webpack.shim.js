...
var webpackShimConfig = {
  ...
  resolveAlias: {
    ...
    'pgadmin.browser.profiling': path.join(__dirname, './pgadmin/misc/profiling/static/js/profiling'),
    ...
    'pgadmin.node.dirobj': path.join(__dirname, './pgadmin/browser/data_groups/datasources/buckets/dirsobjs/static/js/dirobj'),
