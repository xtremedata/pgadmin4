define([
  'sources/gettext', 'jquery', 'underscore', 'sources/pgadmin', 'backbone', 'pgadmin.backform',
  'pgadmin.backgrid', 'select2', 'pgadmin.browser.node',
],
function(gettext, $, _, pgAdmin, Backbone, Backform, Backgrid) {
