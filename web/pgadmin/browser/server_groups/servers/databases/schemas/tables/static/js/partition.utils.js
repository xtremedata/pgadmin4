define('pgadmin.node.table_partition_utils', [
  'sources/gettext', 'jquery', 'underscore', 'backbone', 'pgadmin.backform',
  'pgadmin.backgrid', 'pgadmin.browser', 'pgadmin.browser.collection',
], function(gettext, $, _, Backbone, Backform, Backgrid, pgBrowser) {
